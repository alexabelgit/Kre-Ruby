SELECT
 ...
 WHERE
	subscriptions.STATE = 3 AND orders.order_date > stores.created_at AND orders.created_at BETWEEN ( subscriptions.next_billing_at - INTERVAL '1 month' ) AND subscriptions.next_billing_at
GROUP BY stores.id
