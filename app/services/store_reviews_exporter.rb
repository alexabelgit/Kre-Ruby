class StoreReviewsExporter
  ...
  def readable_name
    ...
    "Reviews export from #{time}"
  end

  def filepath(store)
    "#{store.hashid}/reviews-#{DateTime.current.to_s(:number)}.csv"
  end
end